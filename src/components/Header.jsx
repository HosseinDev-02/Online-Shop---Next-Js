...
import { TbCopy, TbShoppingBag, TbUserSquareRounded } from "react-icons/tb";
import { userProfileLinks, specialLinks, categoryItems } from "@/utils/data";
...
export default function Header() {
    return (
        <>
            {/* Desktop Header */}
            <header className="hidden md:block bg-white w-full pt-5">
                <Container>
                    {/* Top */}
                    <div className="flex justify-between gap-6 h-full">
                        ...
                        <div className="max-w-[638px] w-full flex items-center gap-2 h-12 rounded-full bg-gray border border-zinc-300 px-3.5">
                            <LuSearch size={20} className="shrink-0" />
                            <input
                                className="h-full w-full outline-none text-sm font-IranSansMedium text-zinc-600 placeholder:text-zinc-400"
                                placeholder="جستجو"
                            />
                        </div>
                        <div className="flex items-center gap-4">
                            ...
                            <div className="group relative">
                                ...
                                {/* User Header Content */}
                                <div className="bg-white rounded-md w-64 absolute left-0 top-14 shadow-[0px_0px_20px_2px_#00000014] invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 delay-100 overflow-hidden z-20">
                                    {/* User Profile Menu */}
                                    <div className="px-4">
                            ...
                            <div className="relative group">
                                {/* Cart Btn */}
                                <button className="w-12 h-12 rounded-xl bg-primary text-white flex items-center justify-center relative cursor-pointer shadow-[0px_0px_20px_2px_#00000014]">
                                ...
                                {/* Cart Content */}
                                <div className="bg-white rounded-md w-sm absolute left-0 top-14 shadow-[0px_0px_20px_2px_#00000014] opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-300 delay-100 z-20">
                                    {/* Cart Items */}
                    ...
                    <div className="py-5 bg-gray rounded-full px-5 lg:px-10 mt-10 font-IranSansMedium flex justify-between relative">
                        ...
                        <ul className="flex items-center gap-4 text-sm lg:text-base">
                            <li className="group/store">
                                ...
                                <div className="absolute right-0 left-0 top-18 bg-white shadow-[0px_0px_50px_10px_#00000014] rounded-xl transition-all duration-300 delay-100 invisible opacity-0 group-hover/store:visible group-hover/store:opacity-100 z-20 overflow-hidden">
                                    {/* Submenu List Items */}
                                        ...
                                        <ul className="flex flex-col">
                                            {categoryItems.map((listItem) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <Link
                                                            className="flex px-6 py-4 gap-2 items-center"
                                                            href={listItem.href}
                                                        >
                                                            <Icon size={20} />
                                                            <span>
            ...
            <>
                {/* Mobile Header */}
                <div className="py-4 px-4 flex md:hidden items-center gap-2 justify-between bg-white shadow-[0px_0px_20px_2px_#00000014]">
                    {/* Logo */}
                    <div className="flex flex-col gap-1 shrink-0">
                        <h2 className="font-RichardRegular text-3xl text-primary tracking-tight">
                            <Link href="/">Digi Market</Link>
                    ...
                    <div className="flex items-center gap-2">
                        <div className="bg-neutral-100 w-10 h-10 flex items-center justify-center rounded-full">
                            <LuSearch size={24} className="shrink-0" />
                        </div>
                        <div className="relative w-10 h-10 flex items-center justify-center bg-neutral-100 rounded-full">
                            <span className="text-xs font-IranSansMedium absolute left-0 top-0 text-white bg-red-500 rounded-full h-4 w-4 flex items-center justify-center">
                                2
                            </span>
                ...
                {/* Mobile Menu Links */}
                <div className="fixed left-0 right-0 bottom-0 w-full py-2 z-20 bg-white flex md:hidden items-center justify-around text-xs font-IranSansMedium px-4 shadow-[0px_0px_20px_2px_#00000014] text-[#606060]">
                    ...
                    >
                        <TbShoppingBag size={24} />
                        <span className="bg-red-500 text-white rounded-full w-4 h-4 text-xxs/loose absolute left-0 top-0 flex items-center justify-center">
                            99
                        </span>
                        <span>سبد خرید</span>
                    </Link>
